...
def new_post():
    ...
    if create_post_form.validate_on_submit():
        ...
        print(post_to_add.title, post_to_add.subtitle, post_to_add.body, post_to_add.author, post_to_add.img_url, post_to_add.date)
...
def delete_post(post_id):
    movie_to_delete = BlogPost.query.get(post_id)
